...
try {
    ...
    foreach ($file in $Files) {
        ...
        try {
            $null = Protect-CUIFile -InputPath $filePath -Password $Password -OutputPath (Join-Path $OutputDir "$file.Locked")
    ...
    # Decryption one-liner (generated by Crypto.psm1, same as Encrypt.ps1)
    $oneLiner = Get-CUIDecryptOneLiner
